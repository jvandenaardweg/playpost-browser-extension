...
export class Popup extends React.Component<AppProps, AppState> {
  ...
  handleOnClickLink = (event: any) => {
    event.preventDefault()
    return chrome.tabs.create({ url: event.currentTarget.href });
  }
      ...
      <div className="Popup">
        <div className="Popup__header">
          <div className="Popup__header-right">
            ...
            <h1 className="Popup__header-title"><a href="https://playpost.app/" onClick={this.handleOnClickLink}>Playpost</a></h1>
          </div>
          <div className="Popup__header-right">
          {token && (
