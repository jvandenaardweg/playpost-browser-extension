    ...
    return (
      <form className="LoginForm" onSubmit={this.handleOnSubmit}>
        ...
        <div className="LoginForm__footer">
          ...
          <div>
            <p><strong>No account yet?</strong> Create your account on <a href={APPLE_APP_STORE_URL} onClick={this.handleOnClickLink}>iPhone</a> or <a href={GOOGLE_PLAY_STORE_URL} onClick={this.handleOnClickLink}>Android</a>.</p>
