...
import { APPLE_APP_STORE_URL, GOOGLE_PLAY_STORE_URL, API_BASE_URL } from '../../constants/urls';
  ...
  render() {
    ...
    return (
      <form className="LoginForm" onSubmit={this.handleOnSubmit}>
        <p className="LoginForm__description">Signin with your Playpost account to share articles to your playlist.</p>
        ...
        <div className="LoginForm__footer">
          ...
          <div className="LoginForm__footer-description">
            <p>Create and manage your account using the<br />Playpost <a href={APPLE_APP_STORE_URL} onClick={this.handleOnClickLink}>iPhone</a> or <a href={GOOGLE_PLAY_STORE_URL} onClick={this.handleOnClickLink}>Android</a> app.</p>
          </div>
        </div>
      </form>
    )
