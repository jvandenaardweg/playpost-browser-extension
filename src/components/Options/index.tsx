...
import { GOOGLE_PLAY_STORE_URL, APPLE_APP_STORE_URL } from '../../constants/urls';
// import { Button } from '../Button';
  ...
  render() {
    ...
    return (
      <div className="Options">
        <h1 className="Options__title">Playpost Extension Options</h1>
          ...
          <div className="Options__section-column-right">
            ...
            {token && (
              <div className="Options__account">
                ...
                <Button title="Logout" onClick={this.handleOnClickLogout} />
              </div>
            )}
          </div>
        </section>
        ...
        <section className="Options__section">
          ...
          <div className="Options__section-column-right">
            <ul>
              <li>
                <div>
                  <label><input type="checkbox" name="auto-save" onChange={this.handleOnChangeSettingAutoSave} checked={autoSave} />Auto save</label>
                  <p>Automatically save the article when you open the extension.<br />Default: off</p>
                </div>
              </li>
              <li>
                <div>
                  <label><input type="checkbox" name="auto-close" onChange={this.handleOnChangeSettingAutoClose} checked={autoClose} />Auto close</label>
                  <p>Automatically close the extension when an article is saved to your playlist.<br />Default: off</p>
                  </div>
              </li>
            </ul>
          </div>
